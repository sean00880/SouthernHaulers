        ...
        <Tabs defaultValue="ports" className="w-full">
          ...
          <TabsContent value="ports" className="space-y-8">
            ...
            <div className="grid md:grid-cols-4 gap-6 mt-12 p-8 bg-gradient-to-r from-primary/5 via-secondary/5 to-primary/5 rounded-2xl border border-primary/20">
              <div className="text-center">
                <div className="text-3xl font-bold bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent mb-2">10M+</div>
              ...
              <div className="text-center">
                <div className="text-3xl font-bold bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent mb-2">2-4hr</div>
          ...
          <TabsContent value="rail" className="space-y-8">
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {railTerminals.map((terminal) => (
                ...
                >
                  ...
                  {/* Content */}
                  <h3 className="text-xl font-bold mb-2">{terminal.name}</h3>
                  <p className="text-sm text-muted-foreground mb-4">
            ...
            <div className="grid md:grid-cols-4 gap-6 mt-12 p-8 bg-gradient-to-r from-secondary/5 via-primary/5 to-secondary/5 rounded-2xl border border-secondary/20">
              ...
              <div className="text-center">
                <div className="text-3xl font-bold bg-gradient-to-r from-secondary to-primary bg-clip-text text-transparent mb-2">4</div>
                <div className="text-sm text-muted-foreground">States Covered</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold bg-gradient-to-r from-secondary to-primary bg-clip-text text-transparent mb-2">100%</div>
                <div className="text-sm text-muted-foreground">Intermodal Access</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold bg-gradient-to-r from-secondary to-primary bg-clip-text text-transparent mb-2">15min</div>
